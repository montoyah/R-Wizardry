...
Answer homework 2 in an RMarkdown document, placing the code inside the chuncks of code and text-based answers outside the chunks. Submit your file to D2L's Dropbox (Assesments > Dropbox > Homework 2), naming the file with your name and "homework 2" (e.g. "John Smith Homework 1").
