...
data$Upper <- data$mean_methane + 1.96 * data$sd
data$Lower <- data$mean_methane - 1.96 * data$sd
head(data, 15)
```
...
boxplot(mean_methane ~ day, data=data[data$compound=="hexane" | data$compound=="benzene",], main = "Uncertainty in mean of methane \nproduction for hexane and benzene", xlab = "Time (days)", ylab = "Mean of methane production (umoles/day)")
