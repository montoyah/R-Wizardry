---
title: "R wizardry course week 4 (final), 2017"
output: pdf_document
...
compounds %>% 
  ...
  slice(15:30)  %>% select(centered) #The centered mean is how many standard deviations each observation is above (positive) or below (negative) the mean.

#Scale can be calculated as Scale = (x - mean(x)) / sd(x) , or simply the reminder divided by the sd. Allows standarization of the data, aka "Z-scores".
```
