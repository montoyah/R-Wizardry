...
# Now, let's write compounds_stats as a csv file
write.csv(compounds_stats, "/home/oscar/MEGAsync/R Wizardry/Materials 2018/Week 3/compounds_stats.csv", row.names = FALSE, quote = FALSE)
```
