...
# Look for a way to keep both the R MArkdown and the latex (latex before it gets converted into rmarkdown). The issue with the possition of the plots can be related to the step where the latex output is converted into a markdown and then render it.
...
data = read.csv("/home/oscar/Dropbox/R-Wizardry/Materials 2017/Datasets/SimDataTrend.csv")
